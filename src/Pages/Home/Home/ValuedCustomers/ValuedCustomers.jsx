                    ...
                    <SwiperSlide>
                        <div className="lg:w-[350px] bg-base-100 shadow-xl mt-6 rounded-xl">
                            <div>
                                ...
                                <div className="flex justify-between p-4">
                                    <div className="flex gap-2">
                                        ...
                                        <div className="space-y-1">
                                            <h1 className="text-[#414141] text-lg font-semibold">Sophie Moore</h1>
                                ...
                                <div className="p-4">
                                    <h1 className="text-[#333333] text-lg font-bold">“One of a kind service”</h1>
                                    <p className="text-[#555555] text-base">Ultrices eros in cursus turpis massa tincidunt sem nulla pharetra diam sit amet nisl suscipit adipis.</p>
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
