    ...
    return (
        <div className="lg:h-[600px] bg-white p-3">
                ...
                <SwiperSlide>
                    <div className="lg:w-[330px] rounded-3xl bg-[#FFF7E2] mt-6 text-center">
                        <div className="relative inline-block my-4">
                            <img src={girlImage} alt="Profile" className="rounded-full w-28 h-28 object-cover" />
                            <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-black text-white px-2 py-1 rounded-full flex items-center space-x-1">
                                <span>4.5</span>
                                <span><FaStar className="text-orange-400"></FaStar></span>
                            </div>
                        </div>
                        <div>
                            <h1>Dr. Vaishali sharma</h1>
                            <p>Ayurveda Practitioner <span>(BAMS, MD)</span></p>
                            <div className="flex items-center gap-2 justify-center">
                                <FaGraduationCap></FaGraduationCap>
                                <p>25 years of experience</p>
                            </div>
                            <p className="flex items-center gap-1 bg-[#3A643B1F] rounded-3xl px-2 py-1 w-1/2 mx-auto text-[#3A643B] font-semibold my-5"><LuPill></LuPill>Skin Specialist</p>
                        </div>
            ...
            <div className="flex justify-center items-center my-7">
                <button className="bg-[#DBE3DC63] px-4 py-3 text-[#3A643B] font-semibold flex items-center gap-3 outline outline-[#3A643B] rounded-md">Find more experts <IoIosArrowForward></IoIosArrowForward></button>
            </div>
        </div>
    );
};
