            ...
            <footer className="footer lg:p-10 p-3 bg-[#3A643B2E] text-base-content">
                ...
                <form>
                    ...
                    <div className="flex items-center rounded-lg p-2">
                        <input type="text" className="flex-grow outline-none px-4 py-2 rounded-l-3xl" placeholder="Enter your text..." />
                        <button className="bg-[#000000] hover:bg-blue-900 text-white px-4 py-2 rounded-r-3xl">Submit</button>
                    </div>
                </form>
            </footer>
        </div>
